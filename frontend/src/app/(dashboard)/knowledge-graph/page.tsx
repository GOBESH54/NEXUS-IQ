...
import { Search, Filter, Maximize, ZoomIn, ZoomOut, Database, Settings, Activity, ShieldAlert, FileText, Users, ArrowLeft } from 'lucide-react';
...
// Needed for Lucide icon in switch statement
